        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard') }}">
                <div class="flex gap-x-2 items-center">
                    <svg class="fill-orange-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
                        <path d="M31.956 14.8C31.372 6.92 25.08.628 17.2.044V5.76a9.04 9.04 0 0 0 9.04 9.04h5.716ZM14.8 26.24v5.716C6.92 31.372.63 25.08.044 17.2H5.76a9.04 9.04 0 0 1 9.04 9.04Zm11.44-9.04h5.716c-.584 7.88-6.876 14.172-14.756 14.756V26.24a9.04 9.04 0 0 1 9.04-9.04ZM.044 14.8C.63 6.92 6.92.628 14.8.044V5.76a9.04 9.04 0 0 1-9.04 9.04H.044Z" />
                    </svg>
                    <span class="text-[20px] font-primaryMedium text-orange-600 lg:opacity-0 lg:sidebar-expanded:opacity-100">Chookiat Care</span>
                </div>
            </a>
        </div>
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['dashboard'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">ระบบฐานลูกค้า</span>
                                </div>
                                <!-- Icon -->
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['dashboard'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('views.index')){{ '!text-violet-500' }}@endif" href="{{ route('views.index') }}?page={{ "create-cus" }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">สร้างลูกค้าใหม่</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('views.index')){{ '!text-violet-500' }}@endif" href="{{ route('views.index') }}?page={{ "cus-list" }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">ข้อมูลลูกค้า</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
