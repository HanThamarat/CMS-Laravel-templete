...
<div class=" flex items-center justify-center modal">
    <div x-data="{ showModal: false, email: '' }">
      ...
      <button
        ...
        class="px-5 py-2 rounded-md duration-100 ease-in-out {{ @$data['otherStyles'] === "" || empty(@$data['otherStyles']) ? "bg-orange-500 hover:bg-orange-600 text-white" : @$data['otherStyles'] }}"
        >
        {{ @$data['btnLabel'] }}
    </button>
      <!-- Background overlay -->
